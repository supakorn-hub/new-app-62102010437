...
OPEN_WEATHER_KEY = '43d466046ea8a4c67be8cceb38f27c64'

NEWS_URL = "http://newsapi.org/v2/everything?q={0}&from=2021-1-30&sortBy=publishedAt&apiKey={1}"

NEWS_KEY = "de36a59c7c784101b2a7ec3498c2f6d7"
...
def CovidNews(): #ดึงข่าว
    url = "http://newsapi.org/v2/everything?q=covid&from=2021-01-02&sortBy=publishedAt&apiKey=de36a59c7c784101b2a7ec3498c2f6d7"
